...
object AppIcons {
    val PadelIcon: ImageVector by lazy {
        ImageVector.Builder(
            name = "Padel",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
